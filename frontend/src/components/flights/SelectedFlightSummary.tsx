      ...
      <div className="flex items-start justify-between gap-3">
        <div className="space-y-0.5">
          ...
          <p className="text-xs font-body" style={{ color: "var(--text-muted)" }}>
            ...
            {" · "}
            <span style={{ color: "var(--accent)" }}>{formatPrice(flight.price, flight.currency)}</span>
          </p>
          {leg.flight_booking?.confirmation_ref && (
            <p className="text-xs font-body" style={{ color: "var(--text-muted)" }}>
              Confirmation: <span className="font-mono" style={{ color: "var(--text-primary)" }}>{leg.flight_booking.confirmation_ref}</span>
            </p>
          )}
        </div>
        <button
